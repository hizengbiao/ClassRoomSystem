...
namespace ClassRoomSystem
{
    public partial class Form18 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                dbConnection.Open();
                string sql = String.Format("insert into [crapply](no,week,weekday,period,applyno,usee,condition)" + "values('{0}',{1},{2},'{3}','{4}','上课','等待')", textBox1.Text, comboBox1.Text, comboBox2.Text, comboBox3.Text, no);
