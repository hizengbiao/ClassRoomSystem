...
namespace ClassRoomSystem
{
    public partial class Form4 : Form
    {
        ...
        public void ShowDeptResult()
        {
            ...
            string sql = "select * from people where job not like 'admin%';";
            //返回查询结果
        ...
        {
            Form9 mainForm = new Form9(value1,value2,value3,value4,value5,value6);
            mainForm.Show();
          //  ShowDeptResult();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
          ...
          {
              dbConnection.Open();
              lo_cmd.CommandText = string.Format("delete from people where no='{0}';", value1);
